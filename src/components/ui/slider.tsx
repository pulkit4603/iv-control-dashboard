...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className='relative h-2 w-full grow overflow-hidden rounded-full border border-neutral-200 bg-gradient-to-r from-neutral-50 to-neutral-400 shadow-2xl'>
