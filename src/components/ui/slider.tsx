...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden border border-neutral-200 shadow-2xl rounded-full bg-gradient-to-r from-neutral-50 to-neutral-400">
      <SliderPrimitive.Range className="absolute h-full bg-gradient-to-r from-neutral-500 to-neutral-950" />
